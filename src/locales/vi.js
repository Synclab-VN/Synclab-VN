module.exports = {
  ...
  process: {
    ...
    steps: [
      { title: "Tìm hiểu nhu cầu", text: "Trao đổi mục tiêu, hiện trạng và vấn đề doanh nghiệp đang gặp phải." },
      { title: "Phân tích bài toán", text: "Xác định luồng nghiệp vụ, dữ liệu, người dùng và phạm vi triển khai." },
      { title: "Đề xuất giải pháp", text: "Đưa ra hướng thiết kế sản phẩm, công nghệ và kế hoạch thực hiện phù hợp." },
      { title: "Thiết kế & phát triển", text: "Xây dựng UI/UX, kiến trúc hệ thống và triển khai tính năng theo từng giai đoạn." },
      { title: "Kiểm thử & triển khai", text: "Kiểm tra chất lượng, tối ưu trải nghiệm và đưa sản phẩm vào vận hành." },
